...
var Piece = /** @class */ (function () {
    ...
    Piece.move = function (e) {
        ...
        if (startSide === 'L') {
            ...
            var piece = ArrayBoards.L[startPosition[0]][startPosition[1]];
            ...
            // Save piece`s class in variable  
            var piece = ArrayBoards.R[startPosition[0]][startPosition[1]];
            // Add selected piece to selected cell as child element
            oppositCell === null || oppositCell === void 0 ? void 0 : oppositCell.append(movedPiece);
            // Move piece in array to selected cell
    ...
    Piece.prototype.movementOfPieces = function (event) {
        var _a, _b, _c, _d, _e;
        var positionStart = [Number((_a = event.target.parentElement) === null || _a === void 0 ? void 0 : _a.id.charAt(0)), Number((_b = event.target.parentElement) === null || _b === void 0 ? void 0 : _b.id.charAt(2))];
